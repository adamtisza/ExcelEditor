...
namespace ExcelReportGenerator
{
    static class CellHandler
    {
        ...
        public static void InsertLineChart(this ExcelWorksheet ws, ExcelRange range, int x, int y, string name, string xLabel = null, string yLabel = null, ExcelRange SerieLabels = null, int width = -1, int height = -1, string title = null)
        {
            var chart = (ExcelLineChart)ws.Drawings.AddChart(name, OfficeOpenXml.Drawing.Chart.eChartType.Line);
            //set the chart's position
            chart.SetPosition(y, 0, x, 0);
        ...
        public static void InsertColumnChart(this ExcelWorksheet ws, ExcelRange range, int x, int y, string name, string xLabel = null, string yLabel = null, ExcelRange serieLabels = null, int width = -1, int height = -1, string title = null)
        {
